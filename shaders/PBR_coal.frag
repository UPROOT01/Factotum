...
layout(binding = 5, set = 1) uniform sampler2D emissivityMap;
...
void main() {
    ...
    float roughness = 0.f;
    vec3 emissivity = texture(emissivityMap, fragUV).rgb;
    ...
    vec3 radiance = gubo.lightColor.rgb * 2.0f;
    ...
    vec3 color = ambient + Lo + emissivity * 2.0;
